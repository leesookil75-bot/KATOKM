...
export default function ParentShuttlePage() {
...
const styles = `
    ...
    .phone-link { color: #2563eb; text-decoration: underline; font-weight: 600; text-align: right; }
    ...
    .map-loading { height: 100vh; display: flex; align-items: center; justify-content: center; color: #94a3b8; }
`;
